...
thanos_version=$(cat ${GITHUB_WORKSPACE}/scripts/utilities-version.json | jq -r .thanos_version )
prom_version=$(cat ${GITHUB_WORKSPACE}/scripts/utilities-version.json | jq -r .prom_version )
argo_version=$(cat ${GITHUB_WORKSPACE}/scripts/utilities-version.json | jq -r .argo_version )
